...
class SCACNN(nn.Module):
    def __init__(self, vocab_size, embed_dim=100, lstm_dim=1000, k=512, dropout=0, fine_tune=False, att_mode=None):
        ...
        self.lstm = nn.LSTM(self.embed_dim + 2048*64, lstm_dim, 1)
    ...
    def forward(self, images, captions, lengths):
        ...
        features = features.view(features.shape[0],2048,-1).permute(0, 2, 1)  # [batch, 49, 2048]
        ...
        return logits, captions, lengths, sort_ind
